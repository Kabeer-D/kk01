...
As a registered user, I want to add products to my cart so that I can review and purchase them later.
As a new user, I want to sign up with a valid email and username so that I can create an account, while only registered users should be allowed to sign in.